...
test('service worker precaches core PWA assets and all 24 game modules',()=>{
  const required=[
    ...
    './icon.svg','./icon-maskable.svg','./src/bootstrap.js','./src/app.js','./src/app/state.js','./src/app/experiment-workflow.js','./src/games/index.js','./src/ui/presentation.js','./src/screens/data-vault.js','./src/screens/player-groups.js','./src/screens/party-history.js','./src/screens/saved-parties.js','./src/screens/party/play-flow.js','./src/screens/home/home.js','./src/screens/analytics/playtest-lab.js','./src/screens/analytics/player-analytics.js','./src/screens/analytics/improvement.js','./src/screens/analytics/game-insights.js',
