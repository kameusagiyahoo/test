...
test('service worker precaches core PWA assets and all 24 game modules',()=>{
  const required=[
    ...
    './icon.svg','./icon-maskable.svg','./src/bootstrap.js','./src/app.js','./src/app/state.js','./src/app/experiment-workflow.js','./src/app/share-actions.js','./src/app/shell-ui.js','./src/app/pwa-lifecycle.js','./src/app/navigation.js','./src/app/runtime.js','./src/games/index.js','./src/ui/presentation.js','./src/ui/playtest-feedback.js','./src/ui/result-presentation.js','./src/screens/data-vault.js','./src/screens/player-groups.js','./src/screens/party-history.js','./src/screens/saved-parties.js','./src/screens/party/play-flow.js','./src/screens/party/context.js','./src/screens/home/home.js','./src/screens/home/context.js','./src/screens/game-detail/game-detail.js','./src/screens/analytics/playtest-lab.js','./src/screens/analytics/player-analytics.js','./src/screens/analytics/player-analytics-context.js','./src/screens/analytics/improvement.js','./src/screens/analytics/game-insights.js','./src/screens/analytics/game-insights-context.js',
